...
public class PasswordHashingDemo {
	...
	public void signup(String username, String password) {
		...
		System.out.println("sign up, saltedPassword=" + saltedPassword + ", hashedPassword=" + hashedPassword);
	...
	public Boolean login(String username, String password) {
		...
		String saltedPassword = SALT + password;
		String hashedPassword = generateHash(saltedPassword);
		System.out.println("login, saltedPassword=" + saltedPassword + ", hashedPassword=" + hashedPassword);
